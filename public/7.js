...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "card-header" }, [_vm._v("Administration")]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _c(
          "router-link",
          { staticClass: "btn btn-primary", attrs: { to: "/admin/product" } },
          [_vm._v("Add product")]
        ),
        _vm._v(" "),
        _c(
          "router-link",
          { staticClass: "btn btn-primary", attrs: { to: "/admin/category" } },
          [_vm._v("Category edit")]
        ),
        _vm._v(" "),
        _c(
          "router-link",
          { staticClass: "btn btn-primary", attrs: { to: "/admin/orders" } },
          [_vm._v("Orders")]
        )
      ],
      1
