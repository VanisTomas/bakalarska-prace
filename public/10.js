          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _this.loading = true;
                _context.next = 4;
                return _apis_Order__WEBPACK_IMPORTED_MODULE_1__["default"].getOrders(page);
...
var render = function() {
  ...
  return _c("div", { staticClass: "card" }, [
    _c("div", { staticClass: "card-header" }, [_vm._v("Your orders")]),
    _vm._v(" "),
    _c(
      "div",
      ...
      [
        _vm.loading
          ...
          : [
              _vm.orders.length
                ? [
                    _c("orders-table", { attrs: { orders: _vm.orders } }),
                    _vm._v(" "),
                    _c("pagination", {
                ...
                : _c("h3", [_vm._v("You have no orders")])
            ]
      ],
      2
    )
